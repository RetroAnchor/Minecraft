...
# Function to click and hold, moving in a 500-pixel square
def click_and_hold_square(start_x, start_y):
    try:
        print("Press P to start clicking and holding in a 500-pixel square.")
        ...
        print("Clicking and holding in a 500-pixel square. Press Ctrl+C to stop.")
        ...
        pyautogui.mouseUp()
        print("\nClicking and holding in a 500-pixel square stopped.")
...
# Call the function to click and hold, moving in a 500-pixel square, when P is pressed
